    ...
    >
      ...
      <div className="flex-1 flex items-center">
        <input
          ...
          disabled={disabled}
          className="w-full bg-transparent text-[var(--foreground)] text-sm placeholder:text-sm sm:placeholder:text-base sm:text-base outline-none caret-[var(--accent)] placeholder:text-[var(--foreground-dim)]/50"
          placeholder={
